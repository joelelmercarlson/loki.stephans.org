...
**/
void CEngine::SetSize(const int& iWidth, const int& iHeight, const int& iDepth)
{
	m_iWidth  = iWidth;
	m_iHeight = iHeight;
	m_pScreen = SDL_SetVideoMode( iWidth, iHeight, iDepth, SDL_OPENGL );
}
...
void CEngine::Init()
{
	...
	SetSize( m_iWidth, m_iHeight, m_iDepth );
